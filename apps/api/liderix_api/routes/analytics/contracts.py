# apps/api/liderix_api/routes/analytics/contracts.py
"""
Contracts Attribution endpoints - v6 using ITstep v6 data
Created: October 14, 2025
Purpose: Detailed contracts attribution to creatives, campaigns, and ads
"""
...
router = APIRouter(tags=["Contracts Attribution"])
...
@router.get("/v6/contracts/detail")
async def get_contracts_detail(
    ...
    Returns: List of contracts with:
    - Contract info (date, amount)
    - Platform attribution
    - Meta: campaign → adset → ad → creative
    - Google: campaign → ad group → keyword
    - Lead form info
    """
    try:
        platform_filter = ""
...
@router.get("/v6/contracts/by-creative")
...
@router.get("/v6/contracts/by-campaign")
...
@router.get("/v6/contracts/timeline")
...
@router.get("/v6/attribution/coverage")
