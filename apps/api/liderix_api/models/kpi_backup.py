...
# User.owned_kpis = relationship("KPI") - removed back_populates to avoid model conflicts
# Project.kpis = relationship("KPI") - removed back_populates to avoid model conflicts